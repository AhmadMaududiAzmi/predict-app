        ...
        <div class="col-12">
            <div class="card mb-0 h-100 overflow-hidden" id="predictContainer">
                ...
                <div class="card-body p-0">
                    <div class="spinner-container d-none mx-auto mt-3" id="spinner">
                ...
                <div class="col-12 row card-header justify-content-between d-flex align-items-center d-none"
                    id="addPredict">
            ...
            <div class="modal-content">
                ...
                <form action="{{ url('grafik') }}" class="modal-body row g-3 requires-validation">
                    ...
                    <div class="col-12">
                        ...
                        <input type="date" required min="2016-01-01" max="2020-12-31" name="tanggal_awal"
                            id="tanggal_awal" class="form-control" value="{{ $startDate }}">
                    </div>
                    <div class="col-12">
                        <label for="tanggalAkhir" class="form-label">Tanggal Akhir</label>
                        <input type="date" required min="2016-01-01" max="2020-12-31" name="tanggal_akhir"
                            id="tanggal_akhir" class="form-control" value="{{ $endDate }}">
                    </div>
...
@section('page-script')
    <script>
        function grafik() {
            ...
            const intervalTime = 10000; // Waktu dalam milidetik (1 detik = 1000 milidetik)
